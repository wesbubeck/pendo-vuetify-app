                                ...
                                <v-card flat class="my-0">
                                    <v-card-text>
                                        ...
                                        <p>
                                            ...
                                            revolutionary ROI. Collaboratively
                                            administrate empowered markets via
                                            plug-and-play networks. Dynamically
                                ...
                                <v-card flat class="my-0">
                                    <v-card-text>
                                        <p>
                                            ...
                                            relationships via premier niche
                    ...
                    <v-tabs-items v-model="tab" class="pt-12 transparent">
                        <v-tab-item>
                            <v-card class="mt-0 px-5">
                                <v-card-text>
                                    <base-subheading
                                        subheading="Description about product"
                                    >
                                        <p
                                            class="grey--text body-2 font-weight-light"
                                        >
                        ...
                        <v-tab-item>
                            <v-card class="mt-0 px-5">
                                <v-card-text>
                                    <base-subheading
                                        subheading="Location of the product product"
                                    >
                                        <p
                                            class="grey--text body-2 font-weight-light"
                                        >
                        ...
                        <v-tab-item>
                            <v-card class="mt-0 px-5">
                                <v-card-text>
                                    ...
                                    <p>
                                        From the seamless transition of glass
                                        and metal to the streamlined profile,
                                        every detail was carefully considered to
                                        enhance your experience. So while its
                                        display is larger, the phone feels just
                                        right.
                                    </p>

                                    <div>
                                        Another Text. The first thing you notice
                                        when you hold the phone is how great it
                                        feels in your hand. The cover glass
                                        curves down around the sides to meet the
                                        anodized aluminum enclosure in a
