                ...
                <v-card>
                    <v-container fluid>
                        <v-row>
                            <v-col cols="12" md="6">
                                <paragraph-heading
                                    >Some Title Here</paragraph-heading
                                >
                                ...
                                <v-card-text class="font-weight-light">
                                    ...
                                    if he lifted his head a little he could see
                                    his brown belly, slightly domed and divided
                                    by arches into stiff sections. The bedding
                                    was hardly able to cover it and seemed ready
                                    to slide off any moment. His many legs,
                                    pitifully thin compared with the size of the
                                    rest of him, waved about helplessly as he
                            ...
                            <v-col cols="12" md="6">
                                <paragraph-heading
                                    >Another Title Here</paragraph-heading
                                >
                            ...
                            <v-col cols="12" md="8">
                                ...
                                <v-card-text class="font-weight-light">
                                    ...
                                    by arches into stiff sections. The bedding
                                    was hardly able to cover it and seemed ready
                                    to slide off any moment. One morning, when
