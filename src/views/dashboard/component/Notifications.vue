<template>
    <v-container id="alerts" fluid tag="section">
                ...
                <v-card>
                    <v-card-text>
                        ...
                        <base-material-alert color="secondary" dark dismissible>
                            <span>PRIMARY</span> — This is a regular alert made
                            with the color "secondary"
                        </base-material-alert>
                        ...
                        <base-material-alert
                            ...
                            dismissible
                        >
                            <span>PINK DARKEN-1</span> — This is a regular alert
                            made with the color "pink darken-1"
                        </base-material-alert>
                    </v-card-text>
                </v-card>
            </v-col>
        ...
        >
            Welcome to
            <span class="font-weight-bold">&nbsp;MATERIAL DASHBOARD&nbsp;</span>
                        ...
                        <v-col cols="12" md="8">
                            <div>
                                ...
                                <div class="grey--text">
                                    ...
                                    Creative Tim. You can choose a social
                                    network or go for the classic version,
